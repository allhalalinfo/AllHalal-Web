  ...
  return (
    <div className="container py-32 max-w-4xl mx-auto min-h-screen">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none text-text-secondary">
        ...
        <h2 className="text-2xl font-bold font-display text-text-primary mt-10 mb-6">Institutions</h2>
        
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b-2 border-border">
                <th className="py-4 font-bold font-display text-text-primary">Institution</th>
                <th className="py-4 font-bold font-display text-text-primary">Region</th>
                <th className="py-4 font-bold font-display text-text-primary">Website</th>
              </tr>
            </thead>
            <tbody>
        ...
        <div className="space-y-4 mb-10">
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Can I open a checking account at a normal bank?</summary>
          ...
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Are credit cards halal?</summary>
          ...
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Do Islamic banks charge late fees?</summary>
          ...
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Is my money insured in an Islamic bank in the US?</summary>
