...
export default function BoycottCheckerClient({ embed = false }: { embed?: boolean }) {
  ...
  return (
    <>
      <section className={embed ? "pb-12" : "relative pb-20 pt-32"}>
        <div className="container relative z-10 mx-auto max-w-2xl">
          ...
          <form
            onSubmit={check}
            className={`${embed ? "mt-0" : "mt-8"} flex flex-col gap-3 sm:flex-row sm:items-end`}
          >
