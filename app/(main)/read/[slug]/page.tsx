...
export default async function CustomArticlePage(props: {
  ...
  return (
    <>
      <main className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#f0f5f4_0%,#eef4f2_18%,#e8f1ef_52%,#ecf3f0_100%)] pb-24 pt-32">
        {/* Ambient background effects - fresh green, blue, purple tones */}
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_22%,rgba(140,110,180,0.14),transparent_24%),radial-gradient(circle_at_78%_12%,rgba(73,110,112,0.16),transparent_26%),radial-gradient(circle_at_55%_78%,rgba(104,134,93,0.12),transparent_24%)]" />
          ...
          <div className="absolute left-[-10rem] top-[8rem] h-[24rem] w-[24rem] rounded-full bg-[rgba(100,160,180,0.12)] blur-3xl" />
          <div className="absolute right-[-10rem] top-[6rem] h-[24rem] w-[24rem] rounded-full bg-[rgba(130,100,170,0.11)] blur-3xl" />
        </div>
