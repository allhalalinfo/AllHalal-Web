        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="border-t-2 border-[#E8E6E1] pt-12 mt-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Link href={`/is-it-halal/e-numbers-complete-guide`} className="group bg-[#FAFAF8] border-2 border-[#E8E6E1] rounded-xl p-6 hover:border-[#4B7A88] transition-colors">
              ...
              <Link href={`/is-it-halal/animal-derived-ingredients`} className="group bg-[#FAFAF8] border-2 border-[#E8E6E1] rounded-xl p-6 hover:border-[#4B7A88] transition-colors">
                <p className="text-xs uppercase tracking-[0.15em] font-bold text-[#4B7A88] mb-2">Published</p>
                <h4 className="text-xl font-bold text-[#2A2419] mb-2 group-hover:text-[#4B7A88]">
