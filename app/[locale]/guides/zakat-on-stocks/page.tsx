  ...
  return (
    <article className="container mx-auto max-w-3xl py-28 md:py-32">
      ...
      <p className="mt-4 text-lg text-text-secondary">
        ...
        <Link href={`/${locale}/guides/nisab-value-today`} className="text-primary underline-offset-2 hover:underline">
          Nisab
        </Link>{" "}
      ...
      <p className="mt-8 text-sm text-text-muted">
        Related:{" "}
        <Link href={`/${locale}/guides/zakat-on-business-assets`} className="text-primary hover:underline">
          Business assets
        </Link>
        ,{" "}
        <Link href={`/${locale}/guides/how-to-calculate-zakat-on-crypto`} className="text-primary hover:underline">
          Crypto
        </Link>
        .
      </p>
