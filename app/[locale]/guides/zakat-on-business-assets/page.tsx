  ...
  return (
    <article className="container mx-auto max-w-3xl py-28 md:py-32">
      ...
      <p className="mt-8 text-sm text-text-muted">
        Related:{" "}
        <Link href={`/${locale}/guides/zakat-on-stocks`} className="text-primary hover:underline">
          Stocks
        </Link>
        ,{" "}
        <Link href={`/${locale}/guides/zakat-on-pension-and-retirement-funds`} className="text-primary hover:underline">
          Pensions
        </Link>
        .
      </p>
