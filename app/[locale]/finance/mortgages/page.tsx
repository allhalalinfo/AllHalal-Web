...
export default async function MortgagesPage(props: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="container py-32 max-w-4xl mx-auto min-h-screen">
      ...
      <h1 className="text-4xl md:text-5xl font-bold font-display text-text-primary mb-6">Guide to Halal Mortgages</h1>
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none text-text-secondary">
        ...
        <h2 className="text-2xl font-bold font-display text-text-primary mt-10 mb-4">How it works</h2>
        ...
        <h2 className="text-2xl font-bold font-display text-text-primary mt-10 mb-4">Top Providers</h2>
        <div className="grid gap-6 mb-10">
          <div className="border border-border p-6 rounded-2xl bg-bg-card">
            <h3 className="text-xl font-bold font-display text-text-primary mb-2">Manzil</h3>
          ...
          <div className="border border-border p-6 rounded-2xl bg-bg-card">
            <h3 className="text-xl font-bold font-display text-text-primary mb-2">Guidance Residential</h3>
          ...
          <div className="border border-border p-6 rounded-2xl bg-bg-card">
            <h3 className="text-xl font-bold font-display text-text-primary mb-2">UIF Corporation</h3>
        ...
        <div className="space-y-4 mb-10">
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Are Islamic mortgages really interest-free?</summary>
          ...
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Why are the rates similar to conventional banks?</summary>
          ...
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Is a halal mortgage more expensive than a traditional one?</summary>
          ...
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold font-display text-text-primary outline-none">Can I refinance my conventional mortgage into an Islamic one?</summary>
