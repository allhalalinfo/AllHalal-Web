  ...
  return (
    <div className="container py-32 min-h-screen">
      <div className="max-w-4xl mx-auto text-center mb-16">
        <h1 className="text-5xl font-bold font-display text-text-primary mb-6">Halal Finance</h1>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        <Link href={`/${params.locale}/finance/mortgages`} className="bg-bg-card border border-border p-8 rounded-3xl hover:border-primary hover:shadow-glow-sm transition-all group">
          ...
          <h2 className="text-2xl font-bold font-display text-text-primary mb-3">Halal Mortgages</h2>
        ...
        <Link href={`/${params.locale}/finance/investing`} className="bg-bg-card border border-border p-8 rounded-3xl hover:border-primary hover:shadow-glow-sm transition-all group">
          ...
          <h2 className="text-2xl font-bold font-display text-text-primary mb-3">Halal Investing</h2>
        ...
        <Link href={`/${params.locale}/finance/banks`} className="bg-bg-card border border-border p-8 rounded-3xl hover:border-primary hover:shadow-glow-sm transition-all group">
          ...
          <h2 className="text-2xl font-bold font-display text-text-primary mb-3">Halal Banks</h2>
        ...
        <Link href={`/${params.locale}/finance/zakat-calculator`} className="bg-bg-card border border-border p-8 rounded-3xl hover:border-primary hover:shadow-glow-sm transition-all group md:col-span-3 lg:col-span-1">
          ...
          <h2 className="text-2xl font-bold font-display text-text-primary mb-3">Zakat Calculator</h2>
