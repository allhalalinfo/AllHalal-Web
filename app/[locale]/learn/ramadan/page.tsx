...
export default async function RamadanGuidePage(props: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="container py-32 max-w-4xl mx-auto min-h-screen">
      ...
      <h1 className="text-4xl md:text-5xl font-bold text-text-primary mb-6">Ramadan & Fasting Guide</h1>
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none text-text-secondary">
        ...
        <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">Core Principles</h2>
        ...
        <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">Important Supplications</h2>
        <div className="bg-bg-card border border-border p-6 rounded-2xl mb-8">
          <h3 className="font-bold text-text-primary mb-2">Dua for Breaking Fast (Iftar)</h3>
        ...
        <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">FAQs about Fasting</h2>
        <div className="space-y-4">
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold text-text-primary outline-none">Does brushing my teeth break my fast?</summary>
          ...
          <details className="bg-bg-card border border-border p-4 rounded-xl cursor-pointer group">
            <summary className="font-bold text-text-primary outline-none">What if I eat or drink forgetfully?</summary>
