      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-16">
        ...
        {filteredItems.length === 0 && (
          <div className="col-span-2 text-center py-12 text-text-secondary">
            ...
            <br />
            <a href="https://apps.apple.com/us/app/allhalal-info-food-scanner/id6756242265" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-semibold mt-2 inline-block">
              Check our full database of 2M+ items in the app &rarr;
            </a>
          </div>
        )}
      </div>
