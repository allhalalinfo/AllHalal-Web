            ...
            <div className="space-y-4 text-lg text-neutral-700 dark:text-neutral-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">Muslim-friendly countries and cities</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl">🏨</span>
                <div>
                  <strong>Halal Hotels</strong>
                  <p className="text-neutral-600 dark:text-neutral-400">Prayer-friendly accommodations</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-2xl">🕌</span>
                <div>
                  <strong>Mosque Finder</strong>
                  <p className="text-neutral-600 dark:text-neutral-400">Find mosques near you</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">Advice for Muslim travelers</p>
                </div>
              </div>
            </div>
          </div>
