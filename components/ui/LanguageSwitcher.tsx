...
export default function LanguageSwitcher({ openUpward = false }: LanguageSwitcherProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className={`absolute left-0 right-0 md:left-1/2 md:-translate-x-1/2 md:right-auto w-full md:w-56 bg-bg-card border border-border rounded-xl shadow-2xl z-[9999] ${
