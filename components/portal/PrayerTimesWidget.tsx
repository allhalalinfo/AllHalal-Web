        ...
        <div className="relative z-10 h-full flex flex-col justify-between" style={{ minHeight: "280px" }}>
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <h3 className="text-2xl font-bold font-display flex items-center gap-2" style={{ minHeight: "32px", minWidth: "180px" }}>
          ...
          <div className="flex items-end justify-between">
            <div>
              ...
              <div className="text-5xl font-black font-display tracking-tight mb-1" style={{ minHeight: "60px", minWidth: "200px" }}>{nextPrayer.name}</div>
              <p className="text-accent-yellow font-bold" style={{ minHeight: "24px", minWidth: "180px" }}>{nextPrayer.time} • in {nextPrayer.in}</p>
            </div>
