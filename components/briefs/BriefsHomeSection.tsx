...
function NewsGridCard({
  ...
  return (
    ...
    >
      <div className="relative h-[6.75rem] overflow-hidden rounded-[1rem] border border-[rgba(47,37,30,0.08)] bg-[rgba(242,237,228,0.65)] sm:h-auto sm:aspect-[1.75/1] sm:rounded-[1.2rem]">
        <BriefMedia
          brief={brief}
          priority
