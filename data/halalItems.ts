...
export const halalItems: HalalItem[] = [
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nShellac (E904) is lac-insect resin. Many allow it as a secretion; others avoid insect-derived glazes.\n\n### Working verdict\n\nFor **Shellac (E904)**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nLac-insect secretion glaze. Scholarly views split; carnauba is the plant alternative.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCheetos cheese seasoning can involve animal enzymes in some markets (notably the US). UK/EU and vegetarian packs differ.\n\n### Working verdict\n\nFor **Cheetos**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nSame market-split enzyme story as Doritos — read the country on the bag.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nOriginal Starburst chews are usually gelatin-free; glycerin/colours vary — do not confuse with Starburst gummies.\n\n### Working verdict\n\nFor **Starburst**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nChews and gummies share a brand name but not a formula. Always confirm you are not holding a gelatin gummy SKU.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nMany Lindt bars are milk chocolate without gelatin, but liqueur centres and seasonal products need checking.\n\n### Working verdict\n\nFor **Lindt Chocolate**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nPlain bars are milk chocolate logic; liqueur centres are the hard avoid.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nKombucha is fermented tea that can contain residual alcohol. Trace levels vary by brand and batch — check ABV and your scholarly comfort.\n\n### Working verdict\n\nFor **Kombucha**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nFermented tea with residual ethanol; comfort with trace ABV varies by scholar.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE472 esters can be plant or animal fats reacted with food acids. The E number alone does not show the fat source.\n\n### Working verdict\n\nFor **E472 (a-f)**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nE472 esters share the E471 fat-origin problem: plant palm is fine; undocumented tallow pathways are not.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE631 (disodium inosinate) can be meat, fish or microbial. Unqualified E631 is doubtful; vegetarian claims clear it.\n\n### Working verdict\n\nFor **E631 (Disodium Inosinate)**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nDisodium inosinate may be meat, fish or microbial. Vegetarian crisps imply the microbial route.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nPepsin is an enzyme from animal stomach lining, commonly porcine — not plant-based.\n\n### Working verdict\n\nFor **Pepsin**, The working verdict is **haram** (or not suitable) for the mainstream commercial product unless a certified exception is documented on the pack.\n\n### Product-specific note\n\nStomach-lining enzyme — commonly porcine. Prefer fungal proteases in supplements.\n\n### Ingredient tracing\n\n1. Ask whether the source is plant, microbial, synthetic or animal\n2. Animal sources need slaughter and species clarity for mainstream acceptance\n3. Processing aids and enzymes inherit the same questions as the named ingredient\n4. When the label is opaque, treat the finished food as doubtful until documented\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "ingredient",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nRennet can be animal, microbial or FPC. Animal rennet from non-halal slaughter is rejected; microbial is widely accepted.\n\n### Working verdict\n\nFor **Rennet**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nMicrobial / FPC cheese is the practical green light; bare “enzymes” on US labels stay opaque.\n\n### Ingredient tracing\n\n1. Ask whether the source is plant, microbial, synthetic or animal\n2. Animal sources need slaughter and species clarity for mainstream acceptance\n3. Processing aids and enzymes inherit the same questions as the named ingredient\n4. When the label is opaque, treat the finished food as doubtful until documented\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "ingredient",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCivet musk comes from civet-cat glands. Not accepted for fragrance or food under mainstream halal standards.\n\n### Working verdict\n\nFor **Civet Extract (Kopi Luwak)**, The working verdict is **haram** (or not suitable) for the mainstream commercial product unless a certified exception is documented on the pack.\n\n### Product-specific note\n\nReal civet musk from animal glands is rejected; synthetic musk notes are fine.\n\n### Ingredient tracing\n\n1. Ask whether the source is plant, microbial, synthetic or animal\n2. Animal sources need slaughter and species clarity for mainstream acceptance\n3. Processing aids and enzymes inherit the same questions as the named ingredient\n4. When the label is opaque, treat the finished food as doubtful until documented\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "ingredient",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nKeratin in haircare is usually hydrolyzed animal protein (wool/feathers). External use is a judgment call; source matters if strict.\n\n### Working verdict\n\nFor **Keratin**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nSalon keratin treatments and shampoo proteins are usually hydrolyzed wool or feather protein. Plant “keratin alternatives” are amino-acid blends, not true keratin.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCollagen is almost always from animal skin or bones. Halal only if source and slaughter are certified; porcine is haram.\n\n### Working verdict\n\nFor **Collagen**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nUnqualified collagen powder is often porcine in cheap gummies. Buy only marked bovine/fish halal sources.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nStearic acid can be plant oils or animal fat. The name alone does not tell you which.\n\n### Working verdict\n\nFor **Stearic Acid**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nSame dual-origin family as magnesium stearate and E471 — plant OK, undocumented doubtful.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCetyl alcohol in cosmetics can be plant oils or animal fats. External use is broadly fine; strict tracers prefer plant-declared sources.\n\n### Working verdict\n\nFor **Cetyl / Cetearyl Alcohol**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nFatty alcohol for creams — not drinking alcohol. Prefer plant/vegan declarations if strict.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nKosher meat is not automatically halal. Slaughter rules overlap but are not identical; many Muslims still require Islamic slaughter.\n\n### Working verdict\n\nFor **Kosher Meat**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nOverlap with Islamic slaughter is incomplete — kosher is not automatic zabiha.\n\n### Ingredient tracing\n\n1. Ask whether the source is plant, microbial, synthetic or animal\n2. Animal sources need slaughter and species clarity for mainstream acceptance\n3. Processing aids and enzymes inherit the same questions as the named ingredient\n4. When the label is opaque, treat the finished food as doubtful until documented\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "ingredient",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCommercial root beer is a sweet soft drink, not alcoholic beer. Standard cans have no animal ingredients.\n\n### Working verdict\n\nFor **A&W Root Beer**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nSoft-drink root beer is fine; hard root beer with ABV is alcohol.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nGinger ale is carbonated water, sweetener and ginger flavour — no animal ingredients in standard commercial formulas.\n\n### Working verdict\n\nFor **Ginger Ale**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nSoft drink, despite “ale”. Craft fermented ginger beer can contain alcohol.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE100 is curcumin / turmeric colour — plant-based and halal.\n\n### Working verdict\n\nFor **E100 (Curcumin)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nCurcumin is turmeric pigment. If a yellow colour blend also lists carmine, judge each colour separately.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE322 is lecithin, usually soy or sunflower — a plant emulsifier; egg lecithin is also halal.\n\n### Working verdict\n\nFor **E322 (Lecithin)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nSoy/sunflower/egg lecithin — plant or egg, not meat gelatin.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE330 is citric acid, usually from fermenting plant sugars — a standard acid in drinks and sweets.\n\n### Working verdict\n\nFor **E330 (Citric Acid)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nCitric acid from fermentation of plant sugars — standard and clear.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE415 is xanthan gum from bacterial fermentation of plant sugars.\n\n### Working verdict\n\nFor **E415 (Xanthan Gum)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nXanthan is a fermentation gum on plant sugar feedstock. Mainstream food-grade xanthan is treated as halal by major certifiers.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE476 (PGPR) is usually plant (castor), but polyglycerol pathways can involve animal fats — prefer vegetable claims.\n\n### Working verdict\n\nFor **E476 (PGPR)**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nPGPR is usually castor-based, but polyglycerol can still raise glycerol-origin questions for strict readers.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE542 is edible bone phosphate from animal bones — not plant-based without certified source.\n\n### Working verdict\n\nFor **E542 (Bone Phosphate)**, The working verdict is **haram** (or not suitable) for the mainstream commercial product unless a certified exception is documented on the pack.\n\n### Product-specific note\n\nBone phosphate is literally from animal bone. Without certified slaughter documentation it is rejected for food use.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE428 is gelatin. Unless the pack states halal bovine or fish gelatin, treat it as non-halal (often porcine).\n\n### Working verdict\n\nFor **E428 (Gelatin)**, The working verdict is **haram** (or not suitable) for the mainstream commercial product unless a certified exception is documented on the pack.\n\n### Product-specific note\n\nE428 means gelatin. Unqualified Western gelatin defaults to non-halal sources.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCarmine lipstick uses insect-derived red pigment. External use has scholarly disagreement; many avoid ingestible traces on lips.\n\n### Working verdict\n\nFor **Lipstick containing Carmine**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nLip products can be partly ingested — many who avoid food carmine skip lip carmine too.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCosmetic HA is almost always bacterial fermentation today, not rooster-comb extract.\n\n### Working verdict\n\nFor **Hyaluronic Acid**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nDrugstore serums almost always use fermentation HA. Rooster-comb extraction is a specialty medical pathway, not the default cream ingredient.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nLanolin is wool grease from sheep. External use is commonly accepted; it is still animal-derived.\n\n### Working verdict\n\nFor **Lanolin**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nWool grease is animal-derived but widely accepted for external creams; vegans skip it.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nPerfume ethanol is denatured alcohol for external fragrance. Many scholars allow it on skin; others avoid alcohol-based sprays.\n\n### Working verdict\n\nFor **Perfume with Alcohol (Ethanol)**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nDenatured perfume alcohol is external; scholarly views differ, oil attars avoid the debate.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nChipotle is not a halal-certified US chain by default. Chicken and steak are conventional; sofritas/veg can still face cross-contact.\n\n### Working verdict\n\nFor **Chipotle**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nUS meat is not certified halal by default; sofritas still faces shared-equipment questions.\n\n### Restaurant reality\n\n1. National brand marketing is not the same as local certification\n2. Meat needs zabiha / certified slaughter — conventional poultry and beef usually do not qualify\n3. Shared grills, fryers and prep surfaces create cross-contact even for vegetarian menu items\n4. Ask the specific store for current certification before assuming a “safe” order\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "fast-food",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nChick-fil-A chicken is not slaughtered to halal standards in the US; not a halal restaurant brand.\n\n### Working verdict\n\nFor **Chick-fil-A**, The working verdict is **haram** (or not suitable) for the mainstream commercial product unless a certified exception is documented on the pack.\n\n### Product-specific note\n\nUS chicken is not zabiha by default. Sides do not make the sandwich halal.\n\n### Restaurant reality\n\n1. National brand marketing is not the same as local certification\n2. Meat needs zabiha / certified slaughter — conventional poultry and beef usually do not qualify\n3. Shared grills, fryers and prep surfaces create cross-contact even for vegetarian menu items\n4. Ask the specific store for current certification before assuming a “safe” order\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "fast-food",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nMany syrups are sugar-based without gelatin, but sauces and seasonal pumps vary — stores are not universally halal-certified.\n\n### Working verdict\n\nFor **Starbucks Syrups**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nSugar syrups are simpler than seasonal sauces; kitchens are not universally certified.\n\n### Restaurant reality\n\n1. National brand marketing is not the same as local certification\n2. Meat needs zabiha / certified slaughter — conventional poultry and beef usually do not qualify\n3. Shared grills, fryers and prep surfaces create cross-contact even for vegetarian menu items\n4. Ask the specific store for current certification before assuming a “safe” order\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "fast-food",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nMarshmallow Fluff is often egg-white based rather than gelatin, but formulas vary — confirm no gelatin on your jar.\n\n### Working verdict\n\nFor **Marshmallow Fluff**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nOften egg-white based rather than gelatin — still verify the jar.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nTwix is biscuit, caramel and milk chocolate — no gelatin in the standard bar. Dairy is the only animal input.\n\n### Working verdict\n\nFor **Twix**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nBiscuit-caramel-chocolate bars do not need gelatin to stay soft.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nSkittles Gummies contain gelatin — unlike original hard-shell Skittles. Treat as a separate, non-halal product unless certified otherwise.\n\n### Working verdict\n\nFor **Skittles Gummies**, The working verdict is **haram** (or not suitable) for the mainstream commercial product unless a certified exception is documented on the pack.\n\n### Product-specific note\n\nDifferent product from original Skittles. Gelatin on the gummy pack is decisive.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nPop-Tarts fillings and frostings vary; some use gelatin, animal shortening pathways or carmine — read each flavour.\n\n### Working verdict\n\nFor **Pop-Tarts**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nFrosting and filling vary by flavour; gelatin and carmine are the main risks.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nRice Krispies Treats use marshmallow, which usually means gelatin — unless certified or gelatin-free.\n\n### Working verdict\n\nFor **Rice Krispies Treats**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nMarshmallow binder usually means gelatin. Plain Rice Krispies cereal is a different product.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nVaseline petroleum jelly is mineral petrolatum for external use — not rendered animal fat.\n\n### Working verdict\n\nFor **Vaseline (Petroleum Jelly)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nPetrolatum is mineral, not tallow. Flavoured lip variants can add other ingredients.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCarmine blush uses cochineal insect pigment. External makeup rulings differ; many who avoid food carmine also skip it on cheeks.\n\n### Working verdict\n\nFor **Blush with Carmine**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nExternal makeup with cochineal; consistency with your food carmine rule helps.\n\n### Cosmetics practice\n\n1. External use is evaluated more leniently than food by many scholars\n2. Still read for carmine, lanolin, keratin, stearates and glycerin if you are strict\n3. Vegan labelling is a practical plant-origin signal\n4. Do not ingest cosmetic products; lip products sit closest to the food boundary\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "cosmetics",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE171 is titanium dioxide, a mineral whitener — not animal-derived (some regions restrict it for safety, not fiqh).\n\n### Working verdict\n\nFor **E171 (Titanium Dioxide)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nMineral whitener. EU food restrictions are safety law, not animal-origin fiqh.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE211 is sodium benzoate, a synthetic soft-drink preservative — not animal-derived.\n\n### Working verdict\n\nFor **E211 (Sodium Benzoate)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nSodium benzoate is synthetic. Soft-drink health debates are not origin rulings.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE202 is potassium sorbate, a synthetic preservative — not animal-derived.\n\n### Working verdict\n\nFor **E202 (Potassium Sorbate)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nSynthetic preservative. Not a gelatin or fat-origin problem.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE903 is carnauba wax from palm leaves — a plant glaze for sweets and fruit.\n\n### Working verdict\n\nFor **E903 (Carnauba Wax)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nPalm-leaf wax. Clear plant glaze versus beeswax or shellac.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nE901 is beeswax — a bee secretion, not insect flesh. Widely accepted for glazing sweets and cheese.\n\n### Working verdict\n\nFor **E901 (Beeswax)**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nBeeswax is a bee secretion, widely accepted; not the same debate as shellac.\n\n### Additive checklist\n\n1. Confirm the E-number or common name matches what you think it is\n2. Look for plant / vegetable / vegan / vegetarian claims when origin can be dual\n3. Prefer a recognised halal mark on the finished food when the additive is ambiguous\n4. Do not transfer a ruling from one E-number to a neighbouring code without reading both\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "additive",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nLocust bean gum (carob gum, E410) is plant fibre from carob seeds — a common ice-cream thickener.\n\n### Working verdict\n\nFor **Locust Bean Gum**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nCarob seed gum is plant. Ice cream can still fail for gelatin or E471 while listing this gum.\n\n### Ingredient tracing\n\n1. Ask whether the source is plant, microbial, synthetic or animal\n2. Animal sources need slaughter and species clarity for mainstream acceptance\n3. Processing aids and enzymes inherit the same questions as the named ingredient\n4. When the label is opaque, treat the finished food as doubtful until documented\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "ingredient",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nTartaric acid is from grapes / wine-industry by-products or synthesis — not an animal additive.\n\n### Working verdict\n\nFor **Tartaric Acid**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nGrape-industry recovery does not make the purified acid an intoxicant.\n\n### Ingredient tracing\n\n1. Ask whether the source is plant, microbial, synthetic or animal\n2. Animal sources need slaughter and species clarity for mainstream acceptance\n3. Processing aids and enzymes inherit the same questions as the named ingredient\n4. When the label is opaque, treat the finished food as doubtful until documented\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "ingredient",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCapri Sun pouches are juice drinks with water, concentrates, sugar and flavour — no gelatin in standard pouches.\n\n### Working verdict\n\nFor **Capri Sun**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nJuice pouch, not a gummy. No gelatin in the classic drink.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nBottled Lipton Ice Tea is tea, water, sugar/sweetener and flavour — no animal ingredients in the standard range.\n\n### Working verdict\n\nFor **Lipton Ice Tea**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nClassic bottles are tea + sweetener. Milk-tea lines are separate.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nSour Punch straws are often starch-based and gelatin-free — confirm pack, colours and glycerin.\n\n### Working verdict\n\nFor **Sour Punch Straws**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nStarch sour candy pattern; confirm no gelatin on your bag.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nAirheads taffy is typically gelatin-free, but glycerin origin and colours need a label check; bites and gum lines differ.\n\n### Working verdict\n\nFor **Airheads**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nUsually gelatin-free taffy; glycerin and colours remain the open checks.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nPepperidge Farm Goldfish use cheese seasoning — enzyme/rennet opacity on US packs keeps them doubtful without a vegetarian or halal claim.\n\n### Working verdict\n\nFor **Goldfish Crackers**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nCheese powder enzymes are the doubt point, especially on US cheddar packs.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nPlain Triscuits are whole wheat, oil and salt — plant-based. Cheese-named seasonings need a short flavour check.\n\n### Working verdict\n\nFor **Triscuit**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nPlain wheat-oil-salt crackers are straightforward; cheese seasonings need a glance.\n\n### Snack aisle habits\n\n1. Read the full ingredient list, not only the front of pack\n2. Gelatin, carmine, animal enzymes and opaque “natural flavors” are the usual tripwires\n3. Country of manufacture matters — US, UK/EU and certified Muslim-market recipes often differ\n4. A vegetarian flash helps rule out gelatin and animal rennet, but not every alcohol-flavour question\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "snack",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nBlack coffee is fine; flavoured Dunkin’ drinks and toppings need checking, and Western kitchens are not generally halal-certified.\n\n### Working verdict\n\nFor **Dunkin' Donuts Coffee**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nBlack coffee is fine; swirls, sauces and meat-breakfast kitchens are where doubt concentrates.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nCelsius is a flavoured energy drink with caffeine, vitamins and sweeteners — no gelatin in standard cans.\n\n### Working verdict\n\nFor **Celsius Energy Drink**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nStandard cans are non-animal. Treat stimulant dose as a health decision separate from fiqh origin.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nGhost Energy is a flavoured caffeinated drink without gelatin or meat ingredients in standard cans.\n\n### Working verdict\n\nFor **Ghost Energy Drink**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nCheck L-carnitine source if you are meticulous; caffeine itself is not the origin issue.\n\n### Soft-drink / beverage notes\n\n1. Standard sodas and iced teas are usually free of animal ingredients\n2. “Ale”, “beer” or “hard” in the name can mean alcohol — check ABV\n3. Cream, milk-tea or dessert variants need their own glance\n4. Caffeine quantity is a health choice, not an origin ruling\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "drink",
    "priority": "high"
  },
  {
  ...
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nImpossible patty is plant-based, but BK cooks it on the same broiler as beef in many markets — cross-contact and bun/sauce checks remain.\n\n### Working verdict\n\nFor **Burger King Impossible Whopper**, The working verdict is **doubtful** until the specific pack in your hand clears the open questions below.\n\n### Product-specific note\n\nPlant patty, shared beef broiler in many markets — kitchen context decides.\n\n### Restaurant reality\n\n1. National brand marketing is not the same as local certification\n2. Meat needs zabiha / certified slaughter — conventional poultry and beef usually do not qualify\n3. Shared grills, fryers and prep surfaces create cross-contact even for vegetarian menu items\n4. Ask the specific store for current certification before assuming a “safe” order\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "fast-food",
    "priority": "high"
  },
  {
    ...
    "detailedReason": "### Snapshot\n\nHeinz Tomato Ketchup is tomatoes, vinegar, sugar, salt and spices — no animal ingredients in the classic recipe.\n\n### Working verdict\n\nFor **Heinz Tomato Ketchup**, The working verdict is **halal** when the usual commercial formula and labelling match what is described below.\n\n### Product-specific note\n\nClassic tomato ketchup is a short plant list. BBQ and mayo hybrids are separate products.\n\n### Condiment / general product notes\n\n1. Classic short ingredient lists are usually easier than novelty flavours\n2. Hybrids and limited editions can reintroduce gelatin, anchovy, alcohol or animal fats\n3. Certified packs settle the question faster than forum anecdotes\n4. Re-check after reformulations — recipes change without announcement\n\n### Practical takeaway\n\nIf a certified pack is available, prefer it. If not, use the checklist above, re-read after any reformulation, and compare related pages in the [Is it Halal?](/is-it-halal) hub when similar ingredients appear on neighbouring products.",
    "category": "other",
    "priority": "high"
  },
  {
